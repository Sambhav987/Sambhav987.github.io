  ...
  connectedCallback() {
    ...
    <nav class="inline-block" aria-label="Main">
       <ul class="flex items-center justify-end space-x-8 text-white font-semibold" role="menubar">
           <li role="menuitem">
               <a href="/tools.html" class="text-xl hover:text-green-400 animate-left">Tools</a>
           </li>
           <li role="menuitem">
               <a href="/projects.html" class="text-xl hover:text-green-400 animate-left">Projects</a>
           </li>
